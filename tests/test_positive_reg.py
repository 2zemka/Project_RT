...
from settings import valid_phone, valid_login, valid_password, \
...
class TestRegistration:
    ...
    def test_get_registration_valid(self, browser):
        ...
        with open(r"../page/Settings.py", 'r', encoding='utf8') as file:
            lines = []
            print(lines)
            for line in file.readlines():
                if 'valid_email' in line:
                    ...
                    lines.append(line)
        with open(r"../page/Settings.py", 'w', encoding='utf8') as file:
